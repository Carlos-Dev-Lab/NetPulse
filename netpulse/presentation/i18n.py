...
ES = {
    ...
    "Run as Administrator  →  scripts/start.bat":
    ...
    "0 dropped": "0 descartados",
    "Packets discarded because the capture queue was full":
        "Paquetes descartados porque la cola de captura estaba llena",
    "200ms refresh": "actualización 200 ms", "No session": "Sin sesión",
    "DATABASE  ( SQLite )": "BASE DE DATOS  ( SQLite )",
    "Capture history retention": "Retención del historial de capturas",
    "Daylight (light)": "Luz de día (claro)", "Paper (light)": "Papel (claro)",
    "Customize the interface without restarting NetPulse. The accent colours the chrome only; green, amber and red stay reserved for status.":
        "Personaliza la interfaz sin reiniciar NetPulse. El acento solo colorea el cromo; el verde, el ámbar y el rojo quedan reservados para el estado.",
    "Violet": "Violeta", "Magenta": "Magenta", "Slate": "Pizarra",
    "Keep everything": "Conservar todo", "7 days": "7 días", "30 days": "30 días",
    "90 days": "90 días", "365 days": "365 días",
    "Keeping every capture session.": "Se conservan todas las sesiones de captura.",
    "Sessions older than": "Las sesiones con más de",
    "days are removed at startup.": "días se eliminan al iniciar.",
    "⚡ Bandwidth Alert": "⚡ Alerta de ancho de banda",
    "🚨 Packet Rate Alert": "🚨 Alerta de tasa de paquetes",
    "⚠  Error": "⚠  Error", "OK": "OK",
